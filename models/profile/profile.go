...
type Profile struct {
	...
	ClubID        uuid.UUID `boil:"club_id" json:"club_id,omitempty"`
	IsClubAdmin   bool      `boil:"is_club_admin" json:"is_club_admin,omitempty"`
	...
	NationalID    string    `boil:"national_id" json:"national_id,omitempty"`
	GenderID      int16     `boil:"gender_id" json:"gender_id"`
	GenderName    string    `boil:"gender_name" json:"gender_name,omitempty"`
	WantReminder  bool      `boil:"want_reminder" json:"want_reminder,omitempty"`
	WantPromotion bool      `boil:"want_promotion" json:"want_promotion,omitempty"`
